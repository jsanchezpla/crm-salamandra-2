...
export default function CitasEventosPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (j.ok) {
        setItems(j.data);
        // Lazy load de counts si quieres; saltamos por ahora.
      }
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      <div className="px-6 lg:px-10 pt-8 pb-5 flex items-end justify-between shrink-0 border-b border-[var(--ink-200)] gap-6 flex-wrap">
        <div>
          <div className="eyebrow mb-1.5 lg:mb-2 flex items-center gap-2">
            <Link href="/citas" className="text-neutral-400 hover:text-neutral-700">Citas</Link>
          ...
          <h1 className="font-display text-[24px] lg:text-[34px] leading-[1.05] text-[var(--ink-900)] tracking-tight">
            Tipos de cita <span className="font-display-italic text-[var(--ink-400)]">— configurables</span>
          </h1>
        </div>
        <button
          onClick={openCreate}
          ...
          <aside className="absolute right-0 top-14 lg:top-0 bottom-0 w-full max-w-md bg-white shadow-2xl flex flex-col">
            ...
            <div className="px-5 py-4 space-y-3 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div>
                  <label className="block text-[11px] font-medium text-neutral-500 mb-1">Buffer antes</label>
                  <input
                    type="number"
                    min={0}
                ...
                <div>
                  <label className="block text-[11px] font-medium text-neutral-500 mb-1">Buffer después</label>
                  <input
                    type="number"
                    min={0}
