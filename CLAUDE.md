...
| `somos` | Alta 12/08/2026, 21 módulos (todo lo que se vende), **sin un solo dato aún**, paleta `#124A55` + `#F59C00` (`scripts/update-somos-brand.js`). Quién es y qué no se le puede tocar lo sabe Jorge o Rodrigo: sigue sin escribir. |
