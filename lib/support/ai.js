 ...
 * SOLO lo necesario, parsear defensivo.
 *
 * (13/09/2026, regla #2) Si el PROVEEDOR falla (sin saldo, clave, 5xx…), el
 * error sube y decide quien llama: el portal da el alta igual y lo apunta en la
 * campana; el botón del ticket responde 502 con el motivo. Hasta hoy la
 * clasificación se lo tragaba y devolvía null, y el botón decía «no ha podido
 * clasificar» sin decir por qué. Una respuesta ilegible sigue siendo null.
 *
...
import { esErrorDeIa } from "../ai/errorLegible.js";
 ...
 * decide si aplicar. Respuesta ilegible → null (el ticket se queda como
 * estaba). Fallo del proveedor → LANZA el error (13/09/2026): quien llama
 * decide qué hacer con él y con qué frase contarlo.
 */
