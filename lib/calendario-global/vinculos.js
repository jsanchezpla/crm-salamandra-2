...
/**
 * Color de un calendario: el de la fila, el de la marca del tenant o la
 * paleta por posición. Exportada el 12/09/2026 para `acceso.js`, que lo usa
 * también con clientes sin fila (`fila = {}`); aquí no cambia nada.
 */
export function colorDe(fila, tenant, i) {
