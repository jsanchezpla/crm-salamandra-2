...
export async function createCheckoutSession(ctx, opts) {
  const {
     ...
     *
     * Se acota en un solo caso: el pago fraccionado de un bono, que va directo
     * a Klarna. El importe que se cobra ahí es el del fraccionado (3 × 130 =
     * 390 €), así que dejar la tarjeta a la vista permitiría pagar 390 € de
     * golpe teniendo la opción de 360 — y con toda la razón se sentiría
     * estafado quien lo hiciera.
     */
