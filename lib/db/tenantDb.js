...
import { defineInventoryProduct } from "../../models/tenant/InventoryProduct.model.js";
...
function initTenantDb(slug) {
  ...
  const InventoryProduct = defineInventoryProduct(sequelize);
  ...
  Client.hasMany(InventoryProduct, { foreignKey: "clientId", as: "purchases" });
  InventoryProduct.belongsTo(Client, { foreignKey: "clientId", as: "client" });
  ...
  // FK durmiente para futura integración con InventoryProduct
  InventoryProduct.hasMany(Cost, { foreignKey: "inventoryProductId", as: "costs" });
  Cost.belongsTo(InventoryProduct, { foreignKey: "inventoryProductId", as: "inventoryProduct" });
