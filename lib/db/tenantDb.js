...
function initTenantDb(slug) {
  ...
  // ── Asociaciones del módulo Clínica ────────────────────────────────────────
  ...
  Client.hasMany(Coordination, { foreignKey: "relatedClientId", as: "coordinations" });
  Coordination.belongsTo(Client, { foreignKey: "relatedClientId", as: "relatedClient" });
