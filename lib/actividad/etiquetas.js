...
const MODULOS = {
  team: "Equipo",
  // Auditorías de desempeño (09/09/2026): módulo propio, así que su propia
  // entrada. Sin esta línea sus filas caen en «Otros» y el filtro por módulo no
  // las encuentra nunca.
  ...
  cuota: "Facturación",
  // Los bonos de sesiones se gestionan desde Facturación (10/09/2026), aunque
  // la tabla sea del módulo de Citas: el rastro lo lee quien lleva el dinero.
  bono: "Facturación",
  ...
  booking: "Citas",
  clinica: "Clínica",
  // Los expedientes de DIAGNÓSTICO (12/09/2026) viven dentro de Clínica: su
  // rastro se lee con el de las sesiones y los informes, no en «Otros».
  diagnostico: "Clínica",
  pacientes: "Pacientes",
  nutricion: "Nutrición",
  outreach: "Captación",
...
const TEXTOS = {
  ...
  "client.estados_por_actividad": "Puso Activo, En pausa o Baja a pacientes y clientes según su actividad",
  ...
  "patient.entrevista.no_necesaria": "Marcó que un paciente no necesita entrevista inicial",
  "patient.entrevista.necesaria": "Volvió a pedir la entrevista inicial de un paciente",
  ...
  // 09/09/2026: el reparto de las facturas del volcado a su paciente
  // (`scripts/atar-facturas-a-su-paciente.js`), que es una pasada y no un clic.
  "billing.invoices_patient_backfill": "Ató las facturas importadas a su paciente",
  // Pedidos
  ...
  "citas.movidas_en_bloque": "Movió a la nueva hora las citas siguientes de una que se repite",
  "citas.canceladas_en_bloque": "Canceló las citas siguientes de una que se repite",
  "citas.borradas_en_bloque": "Borró para siempre las citas siguientes de una que se repite",
  // Las citas de un bono que llegó de fuera con sesiones ya gastadas se
  // numeraban desde la 1 (18/09/2026, `scripts/renumerar-sesiones-de-bono.js`).
  "citas.bono_sesiones_renumeradas": "Corrigió el número de sesión de citas de un bono traído de fuera",
  "pacientes.fusionados": "Fundió dos fichas de paciente duplicadas en una",
  ...
  // Los DIAGNÓSTICOS (12/09/2026, Rodrigo con Isa): el expediente de un
  // producto de horas. Parar y seguir mueven dinero (nace un cobro pendiente,
  // y al seguir además un bono sin tope); desbloquear sube el tope de horas.
  "diagnostico.abierto": "Abrió un diagnóstico a un paciente",
  "diagnostico.parado": "Paró un diagnóstico tras la entrevista inicial (nace el cobro de la entrevista)",
  "diagnostico.seguido": "Siguió con un diagnóstico (nacen el bono sin tope y su cobro)",
  "diagnostico.cobrado": "Mandó a cobro una fase de un diagnóstico (la entrevista inicial o el producto)",
  "diagnostico.horas_desbloqueadas": "Desbloqueó más horas en un diagnóstico",
  "diagnostico.cerrado": "Cerró un diagnóstico",
  "diagnostico.borrado": "Borró un diagnóstico (sin bono, sin cobro y sin informe)",
  "diagnostico.terapeuta_cambiado": "Cambió el terapeuta asignado a un diagnóstico",
  "diagnostico.editado": "Cambió el producto o las notas de un diagnóstico",
  // La segunda entrega (12/09/2026): el informe de valoración diagnóstica nace
  // desde el expediente y se une con la IA a partir de sus registros
  // terminados. Ni el texto de los registros ni la propuesta van al log.
  "diagnostico.informe_creado": "Creó el informe de valoración diagnóstica de un diagnóstico",
  "diagnostico.informe_unido": "Unió con la IA los registros de un diagnóstico en su informe",
  // Calendario y notas
  ...
  // Desde el 12/09/2026 un admin de Salamandra puede entrar en un cliente sin
  // cuenta vinculada, con la cuenta admin del cliente. Se escribe en el tenant
  // DEL CLIENTE con el usuario de Salamandra, para que salga en SU Actividad
  // (docs/decisions/2026-09-12-el-calendario-global-ve-todos-y-los-proyectos.md).
  "calendario_global.salto.como_admin": "Entró en el CRM como administrador desde el calendario global de Salamandra",
  ...
  "buzon.aviso_escrito": "Escribió a una persona de un cliente desde el Buzón",
  ...
  "buzon.enviado_a_resuelto": "Envió un aviso del Buzón de ayuda a Resuelto",
  "buzon.sincronizado_con_registro": "Un aviso del Buzón de ayuda siguió a su tarea del Registro",
  ...
  // Hitos (12/09/2026): hoy solo lo escribe el calendario global al mover la
  // fecha de un hito (`after.desde: "calendario_global"`).
  "project.milestone.updated": "Editó un hito de un proyecto",
  ...
  // Bonos de sesiones desde Facturación (10/09/2026). El bono no se borra: se
  // anula, y por eso no hay `bono.deleted`.
  "bono.created": "Dio un bono de sesiones",
  "bono.updated": "Corrigió un bono de sesiones",
  "bono.anulado": "Anuló un bono de sesiones",
  "bono.renovado": "Volvió a dar un bono de sesiones",
  ...
  // Una sola vez (14/09/2026, scripts/limpiar-auditoria-citas.js): la fila con
  // el recuento de lo que se reescribió; sin nombres.
  "citas.auditoria_limpiada": "Quitó los datos de pacientes que se habían copiado en el registro de las citas",
  ...
  "clinica.coordination.updated": "Corrigió un acta de coordinación",
  "clinica.coordination.repaired": "Recompuso un acta de coordinación que se había guardado troceada",
  ...
  // Auditoría de desempeño (09/09/2026, módulo `auditorias`): cerrar una es
  // firmar una valoración laboral de una persona, y borrar un borrador se lleva
  // por delante lo que alguien escribió. Las dos dejan rastro; escribirla no,
  // que sería una fila por tecla.
  "auditorias.auditoria.cerrada": "Cerró una auditoría de desempeño",
  "auditorias.auditoria.deleted": "Borró el borrador de una auditoría de desempeño",
  ...
  "clinica.perfil.updated": "Cambió lo que la IA sabe del centro",
  "clinica.encargo.ia": "Le pidió un texto a la IA desde un registro de sesión",
  ...
  // Sprint 2 (06/09/2026)
  "mailing.campana.ia": "Redactó una campaña de mailing con IA",
  "mailing.campana.ab_decidido": "Decidió el asunto ganador de un A/B de mailing",
  "mailing.secuencia.created": "Creó una secuencia automática de mailing",
  "mailing.secuencia.updated": "Cambió una secuencia automática de mailing",
  "mailing.secuencia.encendida": "Encendió una secuencia automática de mailing",
  "mailing.secuencia.apagada": "Apagó una secuencia automática de mailing",
  "mailing.secuencia.deleted": "Borró una secuencia automática de mailing",
  // Documentos
  ...
  // IA
  "ai.uso": "Usó la IA",
  "ai.tope_frenada": "Se quedó sin IA por el tope de gasto del mes",
