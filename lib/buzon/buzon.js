...
export const ESTADOS = [
  ...
  // Tercero (Jorge, 15/09/2026): se le ha dado respuesta al cliente y no hace
  // falta Registro (una duda, un «cómo se hace»). Se pone a mano; como el
  // enviado, cuenta como cerrado y vuelve a «Activos» si el cliente escribe.
...
export function estadoActual(estado) {
  return ESTADOS_ANTIGUOS[estado] ?? estado;
}
