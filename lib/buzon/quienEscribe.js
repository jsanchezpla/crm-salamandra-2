 ...
 *
 * (Fichero nuevo en /lib, regla #2: lo usan los tres endpoints del lado del
 * cliente. Está aparte porque la parte importante —de dónde sale el correo— es
 * justo la que se hace mal si cada uno lo resuelve por su cuenta.)
 *
