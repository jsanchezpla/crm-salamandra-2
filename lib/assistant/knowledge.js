...
export const CRM_KNOWLEDGE = [
  ...
  { title: "Clínica — Mi desempeño", path: "/clinica/mi-desempeno", keywords: ["desempeño", "desempeno", "rendimiento", "incentivo", "puntuacion", "areas"],
    help: "En Clínica → «Mi desempeño» cada terapeuta ve su puntuación por áreas, complementos y evolución. «Dirección» muestra el ranking del equipo." },
  ...
  { title: "Inventario", path: "/inventario", keywords: ["inventario", "stock", "producto", "almacen", "material"],
    help: "Inventario controla entradas, salidas, fórmulas y movimientos de stock." },
