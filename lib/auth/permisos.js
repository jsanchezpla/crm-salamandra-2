 ...
 *     Olga y Rosa no son terapeutas: llevan la contabilidad, y hasta el
 *     09/09/2026 entraban como `user` con `billing` en su acceso (ese día
 *     Rodrigo las pasó a `admin`). Que hoy manden no deshace la regla: el
 *     caso vuelve en cuanto un centro ponga a administración a cobrar sin
 *     darle la dirección. Por eso el dinero se gatea con
