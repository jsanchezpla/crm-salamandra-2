 ...
 */
export async function packActivoDe(tenantModels, { email, clientId, eventTypeId }, ahora = new Date()) {
 ...
 */
export async function asignarSesion(tenantModels, { email, clientId, eventTypeId }, ahora = new Date()) {
  const activo = await packActivoDe(tenantModels, { email, clientId, eventTypeId }, ahora);
 ...
 */
export async function elegirPack(tenantModels, { packId, email, clientId, eventTypeId }, ahora = new Date()) {
