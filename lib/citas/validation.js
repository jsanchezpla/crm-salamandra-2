...
const HORA_RE = /^(\d{1,2}):(\d{1,2})(?::\d{1,2}(?:\.\d+)?)?$/;

/**
 * Convierte HH:MM o HH:MM:SS a minutos desde medianoche.
 *
 * La cadena se mira ENTERA contra un patrón, no a trozos con `parseInt`
 * (20/08/2026): `parseInt` lee hasta la primera letra y se calla, así que
 * «10:3x» pasaba por las 10:03 y «0x10:30» por las 00:30. Desde el 19/08
 * `normalizeTime` se apoya en esta función, o sea que lo que aquí cuele es lo
 * que se guarda como tramo de agenda.
 */
