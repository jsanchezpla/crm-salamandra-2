...
import { esValoracionInicial } from "./valoracionInicial.js";
 ...
 *
 * Delega en el helper único (05/08/2026). Había dos funciones decidiendo lo
 * mismo con criterios distintos —una con `Boolean(...)`, otra con `=== true`—,
 * y en esta cita concreta esa diferencia importa: es la que se salta la firma
 * del contrato. Dos criterios que hoy coinciden por casualidad son dos
 * criterios que mañana divergen, y el que divergiera aquí abriría una excepción
 * a la puerta de contratos sin que nadie lo viera venir.
 */
export function esCitaDeValoracion(eventType) {
  return esValoracionInicial(eventType);
}
