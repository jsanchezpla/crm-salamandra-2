...
import { serializarPlantilla, situacionDocumentos } from "../clients/contratoFirma.js";
...
export async function estadoContrato(tenantModels, client, guardian) {
  ...
  const docs = situacionDocumentos({ plantillas, firmas, firmantes, firmante });
  ...
  return {
    ...
    siguienteDocumento: siguiente ? serializarPlantilla(siguiente) : null,
