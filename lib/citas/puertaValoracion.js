...
import { estadoDeAdmision, urlDelFormulario } from "./puertaFormulario.js";
 ...
 * @param {object}  opciones.FormSubmission    modelo del tenant
 * @param {string}  opciones.email             correo de quien reserva
 */
export async function puedePedirValoracion(tenant, { tieneFormularios, FormSubmission, email }) {
  ...
  const estado = await estadoDeAdmision(FormSubmission, email);
  return { puede: estado === "aceptada", estado };
}
