 ...
 *
 * ── Y DE QUÉ CITA SE VIENE (10/09/2026, Rodrigo) ──────────────────────────
 ...
 *
 * El cajón rellenaba con la cuota MENSUAL de la familia y la cita de la que se
 * venía no pintaba nada: daba igual pulsar «Cobrar» en la sesión de pedagogía
 * de los martes o en la valoración diagnóstica de 650 €. Con `cita` viaja de
 * cuál se viene, y Cobros pregunta qué se cobra por ELLA
 * (`/api/citas/cobro-del-mes?booking=…`): si es algo que la cuota mensual no
 * cubre —un diagnóstico, un informe—, se cobra eso.
 */
export function urlCobrarMes({ clientId, patientId = null, mes = null, bookingId = null } = {}) {
  ...
  if (bookingId) sp.set("cita", String(bookingId));
