...
export const RESULTADOS_CITA = Object.freeze([
  ...
  },
  {
    ...
    motivo: {
      ...
      /*
       * Y QUÉ PASA CON EL BONO (16/09/2026, AV-0161 de Aumenta, Olga: «al
       * intentar cancelarla y que no cuente la sesión de bono, no funciona»).
       *
       * Sí funcionaba: la regla del contrato es que una cancelación con menos
       * de 24 horas SÍ gasta la sesión (`lib/citas/gastaSesion.js`). Lo que no
       * funcionaba era esta ventana, que decía «ni vino ni contaba como falta»
       * —o sea, lo contrario— y no mencionaba el bono en ningún sitio. Quien
       * cancela tiene que saber qué le va a pasar a la sesión ANTES de pulsar.
       */
      texto: "Se le avisará por correo si tiene consentimiento y correo en su ficha. Si la cita va con bono: cancelando con 24 h o más no gasta sesión; con menos de 24 h, sí.",
      etiqueta: "Motivo (opcional)",
      confirmar: "Cancelar la cita",
      cancelar: "Volver",
    },
    ayuda: "La cita no se da y no cuenta como falta. Con bono: solo gasta sesión si se cancela con menos de 24 h.",
  },
]);
