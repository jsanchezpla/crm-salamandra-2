...
import { resumenDeCita } from "./resumenDeCita.js";
...
export async function cancelBookingRow({
  ...
  // Un RESUMEN de la cita, nunca la fila: la auditoría vive en master
  // (13/09/2026, `resumenDeCita.js`). Antes del update, para tener la foto.
  const before = resumenDeCita(booking);
