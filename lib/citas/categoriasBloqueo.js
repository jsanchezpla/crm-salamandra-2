...
export const CATEGORIAS_CLINICA_BASE = Object.freeze([
  ...
  // Ciruela y no el añil `#4338CA` con el que nació esta lista, y por una razón
  // medida (01/09/2026): puesto en la agenda de verdad —quince columnas, la
  // banda de la reunión de equipo a las 13:00— el añil quedaba ATRAPADO entre el
  // azul de `reunion_equipo` y el morado de `trabajo_interno`, a ΔE 21 y 19 en
  // Lab. Por debajo de 25 el ojo no los separa a la primera, y encima se daban
  // pegados: las horas reservadas caen a las 16:00, justo debajo del trabajo
  // interno de las 15:00. Con el ciruela la distancia al más parecido sube a 41
  // y la peor pareja de toda la paleta pasa a ser 27, o sea ninguna confundible.
  { key: "reservado_paciente", label: "Hora reservada a un paciente", color: "#86198F" },
]);
