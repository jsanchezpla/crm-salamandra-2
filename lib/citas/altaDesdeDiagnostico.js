 ...
 *   · `duracion`     — minutos, múltiplo de 15 y como mucho 480. En la
...
/**
 * La duración de una sesión de diagnóstico va de cuarto en cuarto de hora,
 * hasta 8 h.
 *
 * Eran medias horas hasta el 18/09/2026, y dejaban fuera las de 45 min —que
 * en Aumenta son un tipo de verdad, «INFORME PARA DIAGNOSTICO»— y cualquier
 * cita del catálogo que no cayera en la media: al apuntarlas contra un
 * expediente, el alta las rechazaba con «minutos en múltiplos de 30». El tope
 * del expediente sigue subiéndose de media en media (`puedeDesbloquear`): una
 * cosa es lo que dura una sesión y otra cuántas horas se contratan.
 */
export const DURACION_PASO_MIN = 15;
