...
export const DESTINOS = Object.freeze(["name", "email", "phone", "age", "reason"]);

/** Tope de longitud por defecto según el tipo, si el campo no declara uno. */
const MAX_POR_TIPO = { text: 200, textarea: 1000, tel: 30, email: 160, select: 120, date: 20, number: 12 };
