...
export const CATALOGO = [
  {
    ...
    modulos: [
      ...
      { key: "clients_avanzado", nombre: "Clientes avanzado", desc: "Lista de espera de admisión: gente esperando plaza, por orden de llegada, que se convierte en ficha cuando entra.", requiere: ["clients"] },
