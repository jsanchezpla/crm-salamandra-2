...
export const CATALOGO = [
  ...
  },
  {
    ...
    modulos: [
      ...
      // No tiene tabla propia: su pantalla lee y escribe leads filtrando por
      // origen, y sus endpoints exigen `leads` y NUNCA `referidos`. Vendido
      // suelto da 403 en su propio módulo.
      { key: "referidos", nombre: "Referidos", desc: "Programa de recomendaciones con formulario público.", requiere: ["leads"], avisa: "Hoy está hecho a medida de un cliente; requiere ajuste." },
