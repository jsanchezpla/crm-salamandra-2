...
export const CATALOGO = [
  ...
  },
  {
    ...
    modulos: [
      ...
      // cobro se salta al movimiento del banco con un botón. Es módulo aparte
      // —y no un campo de billing— porque depende de un proveedor externo con
      // sus consentimientos de 90 días, y se vende como extra.
      { key: "banco", nombre: "Banco", desc: "El extracto de tu banco dentro del CRM: movimientos reales (solo lectura, PSD2), conciliación con cobros y gastos, y salto del cobro al movimiento.", requiere: ["billing"], avisa: "Necesita las credenciales gratuitas de GoCardless Bank Account Data del propio cliente, y el consentimiento del banco se renueva cada 90 días." },
