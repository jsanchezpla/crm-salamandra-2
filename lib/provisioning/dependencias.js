...
export const DEPENDENCIAS = [
  ...
  { modulo: "team", paraFuncionar: "No", resumen: "Funciona solo al 100 %.", necesita: [] },
  {
    ...
    necesita: [],
    nota:
      "Es el más independiente del CRM: sus nueve modelos son suyos y no toca ni una tabla de otro módulo. Ojo al venderlo: las matrículas se hacen POR EMPRESA, así que a un cliente B2C que venda cursos a particulares hoy no se le puede matricular a nadie desde el CRM.",
  },
];
