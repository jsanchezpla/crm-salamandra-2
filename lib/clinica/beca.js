...
/**
 * Los apartados del informe de beca, en su orden de lectura. NO pasan por
 * `lib/clinica/plantillas.js` ni el centro puede cambiarlos (29/08/2026): esta
 * lista la manda la convocatoria, no quien redacta. Comparten con los apartados
 * de plantilla la forma `{ key, label, tipo }` para que el generador los
 * imprima con el mismo bloque.
 *
...
export const SECCIONES_BECA = [
  { key: "motiveOfIntervention", label: "Motivo de consulta", tipo: "texto" },
  { key: "objectives", label: "Objetivos", tipo: "lista" },
  { key: "methodology", label: "Metodología", tipo: "texto" },
];
