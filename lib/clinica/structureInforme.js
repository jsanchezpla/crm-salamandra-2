...
import { bloquesDelInforme, mensajeDeInforme, partesDelPromptDeInforme } from "./informeMaterial.js";
 ...
 */
export async function structureInforme({ transcription, apartados, escrito, paciente, tipo, centro = null, apiKey, model }) {
