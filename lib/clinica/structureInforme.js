 ...
 */
export async function structureInforme({ transcription, apartados, escrito, pruebas = null, paciente, tipo, centro = null, apiKey, model }) {
  ...
  const { texto: raw, parada } = await completeConParada({
    ...
    user: mensajeDeInforme({ transcription, escrito, bloques, pruebas, tipo }),
    model,
