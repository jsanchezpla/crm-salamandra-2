...
export function serializePerformance(m, { therapist, history = [], teamAverage = null, tiers = null } = {}) {
...
// llamada. La propuesta se deriva en vivo si nos pasan los tramos.
export function serializeRankingRow(m, { therapist, tiers = null } = {}) {
  const j = m.toJSON ? m.toJSON() : m;
  const areas = {};
