...
export function serializePerformance(m, { therapist, history = [], teamAverage = null, tiers = null, extras = 0 } = {}) {
...
// es tramos + extras.
export function serializeRankingRow(m, { therapist, tiers = null, extras = 0 } = {}) {
  const j = m.toJSON ? m.toJSON() : m;
  const areas = {};
