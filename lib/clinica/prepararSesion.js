 ...
 */
export function colaDePreparacion(scheduledAt, { bookingId = null, ahora = new Date() } = {}) {
 ...
 */
export function payloadDePreparacion({ patientId, therapistId, fecha, prepText, bookingId } = {}) {
