...
export async function filasDe({
  ...
  const deLaEntrevista = cobroDeLaEntrevista(cat.conceptoEntrevista);
  const textoEntrevista = deLaEntrevista.texto;
  ...
  return lista.map((e) => {
    ...
    return filaDeExpediente({
      ...
      cobroEntrevista,
      cobroAlSeguir,
      importeEntrevista: deLaEntrevista.importeEuros,
      puedeDecidir,
      ahora,
      conCitas,
      ...extraDe(e),
