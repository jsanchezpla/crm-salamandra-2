...
const SAFE_AUDIT_KEYS = new Set([
  ...
  "coordinationDate",
  "dueDate",
  // Incidencias (02/09/2026): enums cerrados (categoría, prioridad,
  // verificación), identificadores y fechas. Fuera a propósito: title,
  // description, subcategory, comments y resolution, que son texto libre y
  // pueden nombrar a un paciente o contar qué le pasa.
  "incidenceDate",
  "category",
  "priority",
  "assignedToId",
