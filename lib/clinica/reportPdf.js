 ...
 */
export async function buildReportPdfBuffer({ report, patientName, therapistName, tenantName, brand }) {
    ...
    try {
      ...
      fichaDatos(doc, F, [
        ...
        [
          ...
          cs.referralSpecialty ? (REFERRAL_SPECIALTY_LABEL[cs.referralSpecialty] ?? cs.referralSpecialty) : "",
        ],
      ]);
