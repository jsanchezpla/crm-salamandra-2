 ...
 */
export async function structureSession({ transcription, apartados, escrito, paciente = null, centro = null, apiKey, model }) {
  ...
  const { texto: raw, parada } = await completeConParada({
    ...
    ...partesDelPromptDeRegistro(bloques, { paciente, centro }),
