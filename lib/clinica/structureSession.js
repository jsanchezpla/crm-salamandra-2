 ...
 * @returns {Promise<{ propuesta: Record<string,string>, structured: object, bloques: Array, incidencia: string|null }>}
...
export async function structureSession({ transcription, apartados, escrito, apiKey, model }) {
  ...
  return { propuesta, structured: estructuraHistorica(propuesta), bloques, incidencia };
}
