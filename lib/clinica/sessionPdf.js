 ...
 *
 *   · Escrito con la plantilla de la entrevista → «Entrevista inicial». Quién
 *     lo decide es `esEntrevistaInicial` (`entrevistaInicial.js`), el mismo
 *     que archiva el registro con los informes en la ficha del paciente.
...
export function tituloDeRegistro(session, { tallerNombre = null, servicio = "" } = {}) {
  ...
  // La pregunta «¿es una entrevista inicial?» la contesta lib/clinica/
  // entrevistaInicial.js, que es también quien decide en qué pestaña de la
  // ficha va (04/09/2026, AV-0042): una sola definición para las dos.
  if (esEntrevistaInicial(s)) {
