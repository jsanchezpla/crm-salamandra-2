...
import { conPaciente } from "./pacienteEnAvisos.js";
...
export function avisoDeComentario({ incidencia, comentario }) {
  ...
  return {
    ...
    // El paciente delante (07/09/2026, AV-0052 de Aumenta): quien recibe el
    // aviso sabe de qué niño va sin abrirla.
    body: conPaciente(`«${incidencia?.title ?? "Incidencia"}» · ${recorte}`, incidencia?.patient),
