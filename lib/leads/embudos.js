 ...
 * Comprobado en producción antes de fijarlas: los cinco clientes que hoy usan
 * el módulo base tienen sus leads en `new`, `contacted` y `lost` (las demos) o
 * ninguno todavía (somos, gm_alvar_alonso). Nadie pierde una etapa que use.
 *
