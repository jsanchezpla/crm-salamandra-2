 ...
 */
// SIN `guardians` a propósito (revisión 02/09/2026): esta lista la usan los
// listados y las exportaciones, y los tutores llevan DNI y teléfono. «A
// nombre de quién» va la factura lo resuelve el servidor en el listado de
// facturas y viaja como `aNombreDe` (lib/billing/datosFiscales.js).
export const ATRIBUTOS_CLIENTE_FACTURA = ["id", "name", "fiscalName", "taxId", "fiscalTaxId"];
