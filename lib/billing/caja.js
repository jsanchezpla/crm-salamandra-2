 ...
 *   { cobrado, entradas, salidas, movimiento, queda }
 */
export function saldoDiarioEfectivo(dias = [], saldoInicial = 0) {
  ...
  return dias.map((d) => {
    ...
    saldo = round2(saldo + movimiento);
    return { ...d, efectivoDelDia: { cobrado, entradas, salidas, movimiento, queda: saldo } };
  });
}
