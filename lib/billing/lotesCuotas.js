...
import { razonSocialPorDefecto } from "./razonSocial.js";
...
export function agruparLoteCuotas({ cobros = [], clientes = [], clientesConFacturaDelMes = [], agrupacion = "pagador", conceptos = [], pacientes = [] } = {}) {
