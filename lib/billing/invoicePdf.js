...
export function buildInvoicePdfBuffer({ invoice, client, settings, partnerName, logo }) {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.on("error", reject);
      renderInvoice(doc, { invoice, client, settings: settings || {}, partnerName, logo });
      doc.end();
    } catch (e) {
      reject(e);
    }
...
function renderInvoice(doc, { invoice, client, settings, partnerName, logo, spec }) {
  const S = {
    titulo: "FACTURA",
