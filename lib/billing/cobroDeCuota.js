  ...
  try {
    ...
    if (BillingConcept) {
      try {
        ...
        // `description` es el «Texto en la factura» del concepto, y viaja SIEMPRE:
        // sin ella `textosDeFacturaDeConceptos` cae al `name` interno y el cobro
        // nace con «Cuota T.O. 45x1» de línea en la factura (17/09/2026).
