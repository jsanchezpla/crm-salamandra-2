...
export function comprobar(texto, nombre) {
   ...
   * tablero las localiza por ficha y los adjuntos cuelgan de ella. Lo único que
   * siguen compartiendo es la fila de `tablero_estado` (tick, reparto y
   * solución, casados por título), y por eso se avisa en vez de callar.
   *
