...
export const TIPOS_CITA_DEMO = [
  ...
  // Tercer tipo (29/08/2026): con dos, la gráfica «Ingresos por servicio» de
  // la portada quedaba en dos barras y la agenda demasiado uniforme. Solo
  // online a propósito: así el catálogo enseña también un tipo sin dirección.
  {
    name: "Sesión online",
    slug: "sesion-online",
    duration: 30,
