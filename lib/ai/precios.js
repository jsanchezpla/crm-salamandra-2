...
/**
 * Dólares por euro, para comparar y enseñar en € (14/09/2026). Hasta hoy era
 * una constante local de `modules/config/tarjetas/ConsumoIA.jsx`; el tope de
 * gasto (`lib/ai/topeDeGasto.js`) convierte con el MISMO número, y dos copias
 * acabarían diciendo cosas distintas. Aproximado a propósito: todo esto es una
 * estimación.
 */
export const USD_POR_EUR = 1.1;
