 ...
 *
 * Desde el 12/09/2026 las rutas que redactan no la piden directamente: piden
 * `getTenantIaKey(ctx)` (`lib/ai/proveedorIa.js`), que devuelve esta o la de
 * OpenAI según el proveedor que haya elegido el tenant.
 *
