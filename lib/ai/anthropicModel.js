 ...
 *
 * Desde el 12/09/2026 el tenant puede redactar con OpenAI en vez de con Claude
 * (`lib/ai/proveedorIa.js`, hermano `openaiModel.js`): las rutas ya no piden
 * este modelo directamente sino `getTenantIaModel(ctx)`, que devuelve el del
 * proveedor elegido. Este fichero sigue siendo la verdad sobre los de Claude.
 *
