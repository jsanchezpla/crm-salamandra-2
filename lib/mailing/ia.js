...
export function fakeRedaccion({ instruccion, imagenUrl = null }) {
  ...
  const bloques = [
    ...
    { id: randomUUID(), tipo: "texto", html: "<p>En la demo la IA no gasta tokens: este texto es de ejemplo. Con tu clave de IA puesta en Configuración, aquí saldría el correo de verdad.</p>" },
  ];
