...
export const TARJETAS = Object.freeze({
  ...
  // y la conciliación de /facturacion/banco. Quien las LEE es el módulo
  // `banco` (lib/banco/gocardlessConfig.js → app/api/banco/**), y solo él.
  gocardless: { pestana: "conexiones", requiere: ["banco"] },
