 ...
 */
export async function pacientesPorFamilia({ clientIds, Patient, hasModule, conMotivo = false }) {
  ...
  try {
    const filas = await Patient.findAll({
      ...
      attributes: ["id", "clientId", "firstName", "lastName", "status", ...(conMotivo ? ["referralReason"] : [])],
