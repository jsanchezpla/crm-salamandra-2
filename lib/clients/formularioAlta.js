...
// ⚠️ NADA de un campo «Dirección» de texto aquí: `Client.address` es JSONB, no
// una cadena. Al pintarlo como texto en la ficha, el `{}` por defecto se colaba
// como hijo de React y tumbaba la pantalla entera. Si algún día se pide la
// dirección completa, hay que tratarla como el objeto que es.
