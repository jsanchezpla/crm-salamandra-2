...
export function normalizarPacientes(lista) {
  ...
  for (const [i, p] of lista.entries()) {
    ...
    const resto = [p.birthDate, p.dni, p.educationCenter, p.educationLevel, p.relationship, p.referralReason].some(
      (v) => limpio(v, 300)
    );
    ...
    pacientes.push({
      ...
      // El DNI del niño (AV-0179): sin esta línea se teclea, se manda y no se
      // guarda, igual que le pasó al motivo de consulta.
      dni: limpio(p.dni, 20),
