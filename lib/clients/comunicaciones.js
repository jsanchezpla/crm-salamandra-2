 ...
 * y se queda igual.
 *
 * `bookingCancelled` salía por DOS sitios —`lib/citas/notificarCancelacion.js`
 * y una copia entera dentro del panel de la cita— y los dos preguntaban a esta
 * lista. El 21/08/2026 las copias se fundieron en `emailCancelacionAlCliente`,
 * así que ahora hay un solo punto de envío y un solo sitio donde la pregunta
 * puede desaparecer.
 */
export const CORREOS_TRANSACCIONALES = [
  {
    plantilla: "bookingCancelled",
    donde: "lib/citas/notificarCancelacion.js (emailCancelacionAlCliente)",
    desde: "20/08/2026",
    motivo:
