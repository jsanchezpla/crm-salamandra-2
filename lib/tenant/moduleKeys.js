...
export const MODULE_KEYS = Object.freeze({
  // Auditorías de desempeño (09/09/2026, AV-0100): la valoración mensual de
  // cada profesional, a mano y cualitativa. Módulo propio y no una pantalla de
  // `team_avanzado` porque se lo venderíamos a cualquier centro con varias
  // personas y alguien que dirige — la pregunta de la regla 16 — y porque no se
  // parece a Desempeño ni a Productividad, que son números automáticos.
  ...
  INVENTORY: "inventory",
  // Mailing (06/09/2026): email marketing por Amazon SES. Se vende aparte y
  // no hereda nada de la pantalla /correo (que no es un módulo).
  MAILING: "mailing",
  ORDERS: "orders",
  SUPPORT: "support",
