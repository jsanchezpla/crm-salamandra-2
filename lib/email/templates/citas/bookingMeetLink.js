...
<p>Ya tienes el enlace para conectarte a tu cita de <strong>${escapeHtml(ctx.eventTypeName)}</strong>.</p>`;
  ...
  // Escapados (10/08/2026). Este correo es, entero, un enlace que alguien acaba
  // de pegar a mano en la ficha de la cita, y salía crudo tanto en el href como
  // en el texto visible: de todo el módulo era el sitio donde más fácil era
  // colar marcado sin querer, copiando de un chat o de un calendario.
  const lines = [
