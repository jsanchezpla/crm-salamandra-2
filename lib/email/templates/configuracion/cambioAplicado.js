...
const NOMBRES = {
  ...
  openaiApiKey: "Clave de OpenAI (transcripción y ChatGPT)",
  aiProvider: "Proveedor de IA para redactar",
  openaiModel: "Modelo de ChatGPT",
  ...
  cloudflareApiToken: "Token de Cloudflare (visitas de la web)",
  anthropicModel: "Modelo de Claude",
  cloudflareAccountId: "Cuenta de Cloudflare",
  cloudflareSiteTag: "Sitio de Cloudflare",
  ...
  // 14/09/2026: llega ya resumido del diff («60,00 € al mes», `resumenDelTope`).
  iaTopeMensual: "Tope mensual de gasto de IA",
  "brand.primaryColor": "Color principal",
  "brand.secondaryColor": "Color secundario",
  "brand.logoUrl": "Logotipo",
  // Los datos del centro que salen impresos en los informes clínicos
  // (28/08/2026). Llegan resumidos desde el diff —el párrafo de protección de
  // datos y las sedes son largos—, así que aquí solo hace falta el nombre.
  "centro.razonSocial": "Razón social del centro",
  "centro.cif": "CIF del centro",
  "centro.telefonos": "Teléfonos del centro",
  "centro.sedes": "Sedes del centro",
  "centro.proteccionDatos": "Aviso de protección de datos de los informes",
  "citas.meetModo": "Modo de videollamada",
  "citas.recordatorios": "Recordatorio de citas",
  "citas.soloConPago": "Reservar online solo pagando",
  "citas.identidadObligatoria": "Reservar online solo con cuenta",
};
