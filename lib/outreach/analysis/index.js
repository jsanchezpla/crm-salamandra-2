 ...
 * pitch, emailDraft } } }.
 */
export async function analyzeLead({ lead, businessLines, settings, companyName, complete, apiKey }) {
  ...
  const model = isAllowedModel(settings?.aiModel) ? settings.aiModel : DEFAULT_MODEL;
