...
> Y desde el **03/09/2026** la retención es una semana en el servidor y dos
> fuera, contadas por número de copias y no por edad (Rodrigo). Ver
> [Una semana aquí, dos fuera](decisions/2026-09-03-una-semana-aqui-dos-fuera.md).
