...
| **Decisiones** | `../decisions/2026-09-12-el-calendario-global-ve-todos-y-los-proyectos.md` (los proyectos se ven y se mueven desde el calendario global y se editan en el CRM) · la transversal `../decisions/2026-07-28-repaso-de-seguridad.md` aplica como a todos |
