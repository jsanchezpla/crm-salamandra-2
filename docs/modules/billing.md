...
| **En este doc** | Visión general · Modelos · La factura guarda a quién se le emitió (26/08/2026) · La factura sabe qué tipo de cita cobró (29/08/2026) · Facturación del mes (31/08/2026) · Estados de factura y transiciones · Lógica de cálculos KPI · Numeración correlativa · Libro IVA y Modelo 303 · Endpoints · Páginas frontend |
...
- **Sin NIF se salta y se lista** (en Aumenta ~100 familias): la vista previa
  ...
  factura activa ese mes se **marca** («ya tiene factura este mes»), pero
  decide la persona: puede ser de otra cosa.
