...
| `bookingCancelled` | "Tu cita ha sido cancelada" | Cancela el CENTRO una cita futura: PATCH/DELETE de `bookings/[id]` y `lib/citas/notificarCancelacion.js` (también al borrar una ficha). Si cancela el paciente, no se le escribe. |
