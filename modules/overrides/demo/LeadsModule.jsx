...
export default function DemoLeadsModule() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ color: active ? "var(--color-primary)" : "#111827" }}
      >
        {value}
      </div>
    </button>
  ...
  return (
    <button
      ...
      style={{
        ...
        color: hover ? "white" : "var(--color-primary)",
      }}
    >
      Atender Lead
    </button>
...
function DemoLeadPanel({ lead, open, saving, onClose, onStageChange, onNotesChange }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderTopColor: "var(--color-primary)", borderTopWidth: 3 }}
      >
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            style={{ borderColor: notesDirty ? "var(--color-primary)" : undefined }}
          />
          {notesDirty && (
            <button
              onClick={saveNotes}
