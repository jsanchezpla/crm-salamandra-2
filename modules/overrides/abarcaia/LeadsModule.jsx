...
export default function QECLeadsModule() {
   ...
   * filtrada: al pulsar una etapa, las demás caían a cero. Ahora
   * `/api/leads?desglose=1` devuelve la cuenta de TODAS las etapas con los demás
   * filtros aplicados, y el total sale de sumarla — con lo que también
   * desaparece la resta a ojo de los referidos, que solo descontaba los que
   * hubieran caído en esta página de 200.
   */
