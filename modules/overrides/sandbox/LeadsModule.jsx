        ...
        <div className="px-6 lg:px-8 pt-8 pb-0">
          ...
          <div className="flex flex-col lg:flex-row gap-3 mb-4">
            <Select
              ...
              className={`lg:w-52 px-4 py-2.5 rounded-xl border ${filtroMotivo ? "border-[#1B3A2D]" : "border-gray-200"} bg-white text-gray-700 font-medium focus:outline-none text-sm shadow-sm transition-colors`}
            />
