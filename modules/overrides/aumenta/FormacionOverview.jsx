...
const SECTIONS = [
  ...
  },
  {
    ...
    // «Matrículas» a secas desde el 13/08/2026, igual que en el overview base y
    // en el menú: este override ya llamaba «Alumnos» a las personas —fue de
    // hecho el que acertó primero— pero le ponía apellido a la otra, y eso
    // bastaba para que Aumenta leyera algo distinto que los demás.
    label: "Matrículas",
...
export default function AumentaFormacionOverview() {
  ...
  return (
    // El ancho lo decide `components/layout/anchoPantalla.js` desde el 13/08/2026,
    // igual que el overview base: eran copy-paste y por eso había que arreglar
    // los dos cada vez. Ver allí por qué esto volvía.
