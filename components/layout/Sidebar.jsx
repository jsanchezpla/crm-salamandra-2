    ...
    <>
      ...
      >
        ...
        <div className="px-5 pt-6 pb-5">
          ...
          {/* Acciones bajo el tenant, en horizontal y a la derecha:
              Configuración (solo admin) · Cerrar sesión · Soporte. Así el pie
              del sidebar queda fino (solo el usuario). */}
        ...
        {/* Usuario (fino: las acciones viven arriba, bajo la tarjeta del tenant). */}
