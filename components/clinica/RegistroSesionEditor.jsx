        ...
        <>
          ...
          >
            ...
            {/* ── Dejar el audio fuera de una pasada (01/09/2026, Rodrigo) ──
                Solo aparece cuando el audio YA está transcrito, que es cuando
                tiene sentido: hasta entonces quitarlo no cuesta nada. A partir
            ...
            {file && transcripcionAudio && (
              <label className="mt-3 flex items-start gap-2 text-[11px] text-neutral-600 cursor-pointer">
                ...
                />
                <span>
                  Usar también el audio en esta pasada.
                  <span className="text-neutral-400">
                    {" "}
                    Desmárcalo para que la IA lea solo tus notas. El audio no se pierde ni se vuelve a transcribir.
                  </span>
                </span>
              </label>
            )}
            ...
            {(file || notas.trim()) && (
              <div className="mt-3 flex justify-end">
                <button
                  ...
                  // Sin audio en la pasada y sin notas no hay nada que leer.
                  disabled={notas.length > MAX_NOTAS || (!conAudio && !notas.trim())}
                ...
                >
                  ...
                  {queEntra === "audio"
                    ...
                    : queEntra === "transcripcion"
                      ? notas.trim()
                        ? "Proponer otra vez con la transcripción y mis notas"
                        : "Proponer otra vez con la transcripción"
