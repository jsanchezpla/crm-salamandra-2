...
const LEADS = [
  ...
  },
  {
    ...
    sector: "Ópticas",
    location: "Salamanca",
    website: "https://opticavisionclara.example",
    phone: "+34 923 667 788",
    email: "info@opticavisionclara.example",
    source: "google_maps",
    rawData: { redes: { instagram: "activo" }, reservas_online: false },
    contacts: [{ name: "Pilar Antón", role: "Propietaria", email: "pilar@opticavisionclara.example", isDecisionMaker: true }],
    analyses: [
      { line: "solutions", score: 64, reasonWhy: "Web informativa sin cita de revisión online; el sector ya reserva y vende por internet.", needs: ["Reserva de revisión online", "Catálogo web"], pitch: "Entrar por la cita de revisión online, que la competencia ya ofrece." },
    ],
  },
  {
    name: "Autoescuela Vía Rápida",
    sector: "Autoescuelas",
    location: "Valladolid",
    website: "https://autoescuelaviarapida.example",
    phone: "+34 983 220 044",
    email: "contacto@autoescuelaviarapida.example",
    source: "paginas_amarillas",
    rawData: { redes: { instagram: "flojo", tiktok: null } },
    contacts: [{ name: "Marcos Gil", role: "Director", isDecisionMaker: true }],
    analyses: [
      { line: "agencia", score: 74, reasonWhy: "Producto muy vendible en vídeo (aprobados, alumnos) y competencia con TikTok activo.", needs: ["Contenido en TikTok/Reels", "Campaña de captación de alumnos"], pitch: "Enseñar el TikTok de un competidor con miles de seguidores." },
    ],
  },
  {
    name: "Panadería Horno de Leña",
    sector: "Panaderías y pastelerías",
    location: "Segovia",
    website: null,
    phone: "+34 921 445 900",
    email: null,
    source: "google_maps",
    rawData: { redes: { instagram: "activo" }, web: null, pedido_online: false },
    contacts: [{ name: "Lucía Sanz", role: "Propietaria", mobile: "+34 622 400 511", isDecisionMaker: true }],
    analyses: [],
  },
  {
    name: "Gestoría Nexo",
    sector: "Asesorías / gestorías",
    location: "León",
    website: "https://gestorianexo.example",
    phone: "+34 987 330 220",
    email: "info@gestorianexo.example",
    source: "linkedin",
    rawData: { redes: { linkedin: "activo" }, portal_cliente: false },
    contacts: [{ name: "David Prieto", role: "Socio", email: "david@gestorianexo.example", linkedin: "in/davidprieto", isDecisionMaker: true }],
    analyses: [
      { line: "solutions", score: 80, reasonWhy: "Clientes recurrentes y cero portal para documentación; hoy va todo por email.", needs: ["Portal de cliente", "Subida segura de documentos"], pitch: "Calcular el tiempo que pierden gestionando documentos por email." },
    ],
  },
  {
    ...
    sector: "Floristerías",
    location: "Zamora",
    website: "https://floristeriapetalos.example",
    phone: "+34 980 500 122",
    email: "hola@floristeriapetalos.example",
    source: "google_maps",
    rawData: { redes: { instagram: "activo", pinterest: "activo" }, tienda_online: false },
    contacts: [{ name: "Rosa Bermúdez", role: "Propietaria", isDecisionMaker: true }],
    analyses: [],
  },
];
