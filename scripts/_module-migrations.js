...
export const ONE_OFF = {
  ...
  "migrate-ai-uso": "MASTER, no toca schemas de tenant: crea `master.ai_uso`, la contabilidad de la IA (una fila por llamada a Claude o Whisper con tokens y coste estimado, 11/09/2026). Se corre a mano una vez, idempotente y aditiva; el código escribe best-effort, así que puede ir antes o después del despliegue, mejor antes para no perder filas",
